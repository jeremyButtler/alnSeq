/*########################################################
# Name waterTwoBitNoGap
# Use:
#  o Holds functions doing a Waterman-Smith pairwise
#    alignments. This uses two bit arrays, but does
#    not use gap extension penalties
# Includes:
...
#ifndef WATERMAN_TWO_BIT_NO_GAP_H
#define WATERMAN_TWO_BIT_NO_GAP_H
...
\-------------------------------------------------------*/
static struct alnMatrixTwoBit * WaterTwoBitNoGap(
