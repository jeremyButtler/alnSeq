...
#  o "../general/generalAlnFun.h"     (No .c File)
...
\-------------------------------------------------------*/
static inline void hirschScore(\
   char refBase,  /*Reference base*/\
   char qryBase,  /*Query sequence*/\
   short gapDiff,  /*gapExtend - gapOpen; used for gap score*/\
   long *scoreOn,  /*Score on and holds the new maximum*/\
   char *dirOn,    /*Current direction & holds next direction*/\
   long *nextSnpScore, /*Holds score used to get snp score*/\
   long *delScore,  /*Holds the deletion score*/\
   struct alnSet *alnSetPtr  /*Holds the alnSetPtr for the alignment*/\
){ /*hirschScore*/\
   long macroSnpScoreL =\
        *(nextSnpScore)\
...
|     o dirOn to hold the next direction
\-------------------------------------------------------*/
static inline void hirschScoreRowEnd(\
   char refBase,  /*Reference base*/\
   char qryBase,  /*Query sequence*/\
   short gapDiff,  /*gapExtend - gapOpen; used for gap score*/\
   long *scoreOn,  /*Holds new maxium score*/\
   char *dirOn,    /*Current direction (updated)*/\
   long nextSnpScore, /*Holds score used to get snp score*/\
   long delScore,  /*Holds the deletion score*/\
   struct alnSet *alnSetPtr  /*Holds the alnSetPtr for the alignment*/\
){ /*hirschScoreRowEnd*/\
...
\-------------------------------------------------------*/
static long scoreHirschFor(
  char *refSeqStr,       /*Reference sequence*/
  ulong refStart,        /*index 0 starting ref base*/
  ulong refLen,          /*index 1 Length of ref*/
  
  char *qrySeqStr,       /*Query sequence*/
  ulong qryStart,        /*Index 0 Starting query base*/
  ulong qryLen,          /*index 1 length of query*/
  
  long *scoreAry,        /*Array of scores to fill*/
  char *dirAry,          /*direction row, for gap extend*/
  struct alnSet *alnSetPtr        /*setttings to use*/
   ...
   return macroGapColL; /*Macro equviulant to a return*/
} /*scoreHirschFor*/
