...
#define defVersion 1.20230619  // Version of find co-infections 
...
// multiple equal directions
  ...
  // 1 = second option
  // 2 = third option
#define defDiagnolPriority 1  // Matches/snps preffered
#define defTopPriority 0      // insertions preferecd
