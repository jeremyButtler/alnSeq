...
#  o This variation does not use the gap extension
#    penalty
...
#ifndef MEM_WATER_NO_GAP_H
#define MEM_WATER_NO_GAP_H
...
' o fun-01 memWaterNoGap:
'   - Run a memory efficent Waterman Smith alignment that
'     does not use the gap extension on input sequences
\~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/

/*-------------------------------------------------------\
| Fun-01: memWaterNoGap
|   - Performs a memory efficent Smith Waterman alignment
|     without a gap extension on a pair of sequences
| Input;
|   - qryST:
